"""bas_spec bs-accept -- mark phase outputs as Accepted."""
...
from bas_spec.models import DocStatus, Phase, PHASE_DESCRIPTIONS, SpecStatus
...
# e.g. if phase is RESEARCH, functional specs + proposal need acceptance for techify.
