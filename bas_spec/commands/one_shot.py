"""bas_spec bs-one-shot -- run all phases without stopping."""
...
def one_shot_command(
    ...
    using the bs-one-shot skill.
    """
    console.print(f"\n[bold]One-shot mode[/bold]")
    console.print(f"Description: {description}")
    console.print(
        "\nThe AI agent should now execute the [bold cyan]bs-one-shot[/bold cyan] skill,"
    )
