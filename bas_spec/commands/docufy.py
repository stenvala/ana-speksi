"""bas_spec bs-docufy -- archive and update truth."""
...
from bas_spec.models import ARCHIVE_DIR, ONGOING_DIR
...
def docufy_command(
    ...
    console.print(f"  bas-spec/archive/{archive_name}/")
    console.print("\nThe AI agent should now update ground truth (bas-spec/truth/).")
    console.print("Invoke the [bold cyan]bs-docufy[/bold cyan] skill for detailed instructions.")
