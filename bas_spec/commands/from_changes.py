"""bas_spec bs-from-changes -- create truth from existing changes."""
...
def from_changes_command(
    ...
    console.print(
        "\nThe AI agent should now execute the [bold cyan]bs-from-changes[/bold cyan] skill"
    )
