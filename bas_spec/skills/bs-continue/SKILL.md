---
name: bs-continue
description: Continue working on a bas-spec change by advancing to the next phase.
phase: null
---

Continue working on a bas-spec change by advancing to the next phase.
...
4. **Story selection (techify, taskify, codify, docufy only)**
   ...
   The user can run `/bs-continue` again later to process the remaining stories.
...
5. **Execute the appropriate phase skill**
   ...
   | ------------------------- | ------------------------------------------- | --------------- |
   | proposal (done)           | Create functional specs per story           | bs-storify      |
   | storify (done)            | Conduct research and create technical specs | bs-techify      |
   | research / techify (done) | Create tasks per story                      | bs-taskify      |
   | taskify (done)            | Implement code changes                      | bs-codify       |
   | codify (done)             | Archive and update truth                    | bs-docufy       |
...
- Always run `uv run bas_spec status` first to know where you are
