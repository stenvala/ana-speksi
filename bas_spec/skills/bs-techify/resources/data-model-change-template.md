...
<!-- Repeat this entire section for each affected domain.
     Structure matches bas-spec/truth/data-models/<domain>.md exactly
...
- [ ] Merge into `bas-spec/truth/data-models/{domain}.md`
- [ ] Create/update enum files in `bas-spec/truth/enums/`
