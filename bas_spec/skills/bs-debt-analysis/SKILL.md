...
3. **Create debt document**
   ...
   Create `bas-spec/technical-debt/<date>-<area>.md` using the template in
...
4. **Report**
   ...
   - Run `bs-new` pointing to this debt document to create a clearing plan
