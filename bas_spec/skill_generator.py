...
from bas_spec.config import inject_config_into_skill, load_config
from bas_spec.models import AgentFramework, AGENT_SKILL_PATHS, AGENT_COMMAND_PATHS
from bas_spec.resources import (
    SKILLS_DIR,
    list_skills,
...
def generate_skills(project_root: Path, frameworks: list[AgentFramework]) -> None:
    ...
    config = load_config(project_root / "bas-spec")
