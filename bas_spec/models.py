"""Core models and constants for bas-spec."""
...
def make_spec_name(jira_item: str, short_name: str) -> str:
    """Create a spec folder name like PROJ-123.add-user-auth."""
    return f"{jira_item}.{short_name}"
